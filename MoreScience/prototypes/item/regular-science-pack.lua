...
local function alterSciencePack(oldName, newName, order, potionNumber)
  ...
  sciencePack.icon = "__MoreScience__/graphics/potions/set-01/potion-" .. numberToString(potionNumber) .. ".png"
  ...
  data:extend({
    {
      ...
      icon = "__MoreScience__/graphics/potions/set-01/potion-" .. numberToString(potionNumber) .. ".png",
      icon_size = 32,
